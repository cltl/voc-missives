...
public class TokenAligner {
    ...
    List<Token> extTokens;
    List<Token> refTokens;
    ...
    public TokenAligner(int maxTokenLookAhead, List<Token> extTokens, List<Token> refTokens) {
    ...
    public static TokenAligner create(List<Token> extTokens, List<Token> refTokens, int maxTokenLookAhead) {
        TokenAligner aligner = new TokenAligner(maxTokenLookAhead, extTokens, refTokens);
        return aligner;
    }
    ...
    private boolean manyToManyAlignment(Token ext, Token ref) {
    ...
    private boolean extTokenMatchesRef(Token ext, Token ref) {
    ...
    private boolean extTokenMatchesHyphenatedRef(Token ext, Token ref) {
    ...
    private boolean extTokensMatchSingleRef(Token ext, Token ref) {
    ...
    private boolean extTokensNotInRef(Token ref) {
    ...
    private boolean refTokensNotInExt(Token ext) {
    ...
    private int lastCovered(Token ref, List<Token> extTokens, int iExt) {
        String matched = "";
        String refText = ref.getText();
        int lookup = 0;
    ...
    private int findToken(Token t, List<Token> otherTokens, int iOther, int maxLookUp) {
    ...
    private boolean matchesHyphenatedRef(Token ext, Token ref) {
        String refText = ref.getText();
    ...
    private boolean matchesSplitRef(Token ext, List<Token> refTokens, int iRef) {
    ...
    private void mapIndices(Token t, int beginTarget, int endTarget) {
        beginToRef.put(t.getBegin(), beginTarget);
        endToRef.put(t.getEnd(), endTarget);
    }

    private void mapIndices(Token ext, Token ref) {
